    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-10">
      <Slider {...settings}>
        {slides.map((slide, idx) => (
          <div key={idx}>
            <div
              className="flex flex-col-reverse md:flex-row items-center text-white rounded-2xl p-6 md:p-12 space-y-6 md:space-y-0 md:space-x-10 bg-gradient-to-r from-[#00354B] to-[#002b3f]"
            >
